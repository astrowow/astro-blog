  ...
  return (
    <article className="group flex flex-col rounded-2xl bg-neutral-100 overflow-hidden transition-shadow duration-300 hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col p-6 gap-4">
        ...
        <div className="flex flex-col items-start gap-2 text-xs text-neutral-500">
        ...
        <h3 className="text-balance text-2xl font-sans font-semibold leading-snug">
        ...
        {excerpt && (
          <p className="text-pretty text-[0.925rem] leading-relaxed text-neutral-600 font-sans">
            {excerpt}
          </p>
        )}
