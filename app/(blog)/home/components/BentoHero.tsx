  ...
  return (
    <div className="flex-1 min-h-0 px-6 md:px-10">
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-4 md:grid-rows-[1fr_1fr_auto] gap-4 h-full">
        ...
        <div className="md:col-span-2 md:row-span-2 rounded-3xl bg-white p-6 md:p-8 flex flex-col justify-center gap-4">
          <h1
            className="text-4xl md:text-5xl lg:text-6xl font-sans font-bold leading-none tracking-tighter"
          ...
          <div className="text-neutral-600 text-sm md:text-base leading-relaxed max-w-md">
            <PortableText
              className="prose-sm"
              value={displayDescription as PortableTextBlock[]}
            />
          </div>
          <Link
            href="#articulos"
            className="inline-flex w-fit items-center gap-2 rounded-full bg-black px-5 py-2.5 text-sm font-mono tracking-wide text-white transition-all duration-300 hover:bg-neutral-800 hover:scale-105"
          >
            Explorar artículos
            <svg
              className="h-4 w-4"
